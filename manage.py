...
# 1. Importing Important Libraries and Files
import os
import string
import time
import nltk
...
lyric_file_path = 'test-files/Rostam_kibamia.txt'

# 2. Loading Lyrics Dataset and Spliting it Accordingly with WhiteSpace
...
clean_lyric = lyric_dataset_load(lyric_file_path)
...
print('--------------------------------------------')
print('Detected Lyrical Content Language : '+lyric_content_lang.upper())
print('--------------------------------------------')
...
print('*** TOTAL CLEAN WORDS IN LYRICS - '+str(total_cleanWords_in_lyrics))
